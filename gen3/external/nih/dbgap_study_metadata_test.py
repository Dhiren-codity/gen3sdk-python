...
@pytest.mark.parametrize("api, auth_provider, expected_api, expected_auth_provider", [
    ...
    ("https://custom.api/v1/study_config/", "custom_auth", "https://custom.api/v1/study_config/", "custom_auth"),  # Custom API and auth
    (None, None, "https://submit.ncbi.nlm.nih.gov/dbgap/api/v1/study_config/", None),  # Edge case: None API
    ("", "", "https://submit.ncbi.nlm.nih.gov/dbgap/api/v1/study_config/", ""),  # Edge case: Empty strings
])
